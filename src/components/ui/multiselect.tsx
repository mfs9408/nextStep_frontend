...
const multiSelectVariants = cva("m-1 rounded-md", {
  variants: {
    variant: {
      default: "border-foreground/10 text-foreground bg-card hover:bg-card/80",
      secondary:
        "border-foreground/10 bg-secondary text-secondary-foreground hover:bg-surface/80",
      destructive:
...
>(
  (
    ...
    const toggleOption = (option: MultiSelectOption) => {
      const exists = selectedValues.find((v) => v.value === option.value);
          ...
          >
            {selectedValues.length > 0 ? (
              ...
              <div className="flex items-center justify-between w-full mx-auto">
                <span className="text-sm font-light text-muted-foreground mx-3">
                  {placeholder}
                </span>
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                >
                  ...
                  <span className="font-light">(Select All)</span>
                </CommandItem>
                {options.map((option) => {
